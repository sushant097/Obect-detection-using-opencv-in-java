 ...
 */
package real_Time_face_detection_problem;

// PATH IS  IN VM OPTION  -Djava.library.path="C:\opencv\build\java\x64"
                    ...
                    if (webSource.grab()) {
                        try {
                            ...
                            for (Rect rect : faceDetections.toArray()) {
                               ...
                               /*Instead of Core.rectangle(frame, new Point(rect.x, rect.y), new Point(rect.x + rect.width, rect.y + rect.height),
                                        new Scalar(0, 255,0));*/
                            }
                            Imgcodecs.imencode(".bmp", frame, mem);// instead of Highgui.imencode(".bmp", frame, mem);
